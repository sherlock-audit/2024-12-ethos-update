...
export const attestationAbi = [
    ...
    outputs: [
      {
        ...
        internalType: 'struct IEthosAttestation.Attestation',
        name: '',
        type: 'tuple',
      },
    ],
  ...
  },
  {
    ...
    name: 'attestationHashesByProfileId',
    outputs: [{ internalType: 'bytes32', name: '', type: 'bytes32' }],
    stateMutability: 'view',
    type: 'function',
  },
  ...
  {
    inputs: [{ internalType: 'uint256', name: 'profileId', type: 'uint256' }],
    name: 'getAttestationHashesByProfileId',
    outputs: [{ internalType: 'bytes32[]', name: '', type: 'bytes32[]' }],
    stateMutability: 'view',
    type: 'function',
  },
  {
    ...
    name: 'getAttestationIndexByProfileIdAndHash',
    outputs: [{ internalType: 'uint256', name: '', type: 'uint256' }],
    stateMutability: 'view',
    type: 'function',
  },
