...
export const voteAbi = [
  ...
  },
  {
    anonymous: false,
    inputs: [
      { indexed: false, internalType: 'bool', name: 'isUnvote', type: 'bool' },
      { indexed: false, internalType: 'bool', name: 'isUpvote', type: 'bool' },
      { indexed: true, internalType: 'uint256', name: 'voter', type: 'uint256' },
      ...
      { indexed: false, internalType: 'uint256', name: 'voteId', type: 'uint256' },
    ],
    name: 'VoteChanged',
    type: 'event',
  },
    ...
    outputs: [
      {
        ...
        internalType: 'struct EthosVote.Vote[]',
        name: 'result',
        type: 'tuple[]',
      },
    ],
