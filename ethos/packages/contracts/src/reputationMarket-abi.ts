...
export const reputationMarketAbi = [
  ...
  {
    inputs: [{ internalType: 'uint256', name: 'creationCost', type: 'uint256' }],
  ...
  {
    inputs: [
      { internalType: 'uint256', name: 'minimumPricePerVote', type: 'uint256' },
      { internalType: 'uint256', name: 'actualPricePerVote', type: 'uint256' },
    ],
    name: 'SellSlippageLimitExceeded',
    type: 'error',
  },
    ...
    inputs: [
      { indexed: true, internalType: 'uint256', name: 'configIndex', type: 'uint256' },
      {
        components: [
          ...
          { internalType: 'uint256', name: 'creationCost', type: 'uint256' },
        ],
        indexed: false,
  ...
  },
  {
    inputs: [
      ...
      { internalType: 'uint256', name: 'maxVotesToBuy', type: 'uint256' },
      { internalType: 'uint256', name: 'minVotesToBuy', type: 'uint256' },
    ],
    name: 'buyVotes',
    outputs: [],
  ...
  },
  {
    inputs: [
      { internalType: 'uint256', name: 'profileId', type: 'uint256' },
      { internalType: 'bool', name: 'isPositive', type: 'bool' },
      { internalType: 'uint256', name: 'votesToSell', type: 'uint256' },
      { internalType: 'uint256', name: 'minimumVotePrice', type: 'uint256' },
    ],
    name: 'sellVotes',
    outputs: [],
    stateMutability: 'nonpayable',
  ...
  },
  {
    inputs: [
      { internalType: 'uint256', name: 'profileId', type: 'uint256' },
      { internalType: 'bool', name: 'isPositive', type: 'bool' },
      { internalType: 'uint256', name: 'votesToBuy', type: 'uint256' },
    ],
    name: 'simulateBuy',
    outputs: [
      { internalType: 'uint256', name: 'purchaseCostBeforeFees', type: 'uint256' },
      { internalType: 'uint256', name: 'protocolFee', type: 'uint256' },
      { internalType: 'uint256', name: 'donation', type: 'uint256' },
      { internalType: 'uint256', name: 'totalCostIncludingFees', type: 'uint256' },
  ...
  },
  {
    ...
    name: 'simulateSell',
    outputs: [
      { internalType: 'uint256', name: 'proceedsBeforeFees', type: 'uint256' },
      { internalType: 'uint256', name: 'protocolFee', type: 'uint256' },
      { internalType: 'uint256', name: 'proceedsAfterFees', type: 'uint256' },
      { internalType: 'uint256', name: 'newVotePrice', type: 'uint256' },
    ],
    stateMutability: 'view',
    type: 'function',
