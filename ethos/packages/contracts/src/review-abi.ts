...
export const reviewAbi = [
  ...
  },
  {
    anonymous: false,
    inputs: [
      { indexed: false, internalType: 'enum EthosReview.Score', name: 'score', type: 'uint8' },
      { indexed: true, internalType: 'address', name: 'author', type: 'address' },
  ...
  {
    inputs: [
      { internalType: 'enum EthosReview.Score', name: 'score', type: 'uint8' },
  ...
  },
  {
    ...
    name: 'reviewIdsByAttestationHash',
    outputs: [{ internalType: 'uint256', name: '', type: 'uint256' }],
    stateMutability: 'view',
    type: 'function',
  },
