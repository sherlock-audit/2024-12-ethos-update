...
export const interactionControlAbi = [
  {
    inputs: [
  ...
  {
    inputs: [{ internalType: 'string[]', name: 'contractNames', type: 'string[]' }],
    name: 'addControlledContractNames',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function',
  },
  ...
  {
    inputs: [],
    name: 'getControlledContractNames',
  ...
  {
    inputs: [{ internalType: 'string', name: 'contractName', type: 'string' }],
    name: 'removeControlledContractName',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function',
  },
  ...
  {
    inputs: [{ internalType: 'address', name: 'contractAddressManagerAddr', type: 'address' }],
