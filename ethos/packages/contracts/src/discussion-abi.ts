...
export const discussionAbi = [
  ...
  { inputs: [], name: 'OnlyAuthorCanEdit', type: 'error' },
  ...
  },
  {
    anonymous: false,
    inputs: [
      { indexed: false, internalType: 'uint256', name: 'author', type: 'uint256' },
  ...
  },
  {
    ...
    inputs: [
      { indexed: false, internalType: 'uint256', name: 'author', type: 'uint256' },
      { indexed: false, internalType: 'uint256', name: 'replyId', type: 'uint256' },
    ],
    name: 'ReplyEdited',
    type: 'event',
  },
  ...
  },
  {
    ...
    name: 'directRepliesInRange',
    outputs: [
      {
        components: [
          { internalType: 'bool', name: 'parentIsOriginalComment', type: 'bool' },
          { internalType: 'address', name: 'targetContract', type: 'address' },
          { internalType: 'uint256', name: 'authorProfileId', type: 'uint256' },
          { internalType: 'uint256', name: 'id', type: 'uint256' },
          { internalType: 'uint256', name: 'parentId', type: 'uint256' },
          { internalType: 'uint256', name: 'createdAt', type: 'uint256' },
          { internalType: 'uint256', name: 'edits', type: 'uint256' },
          { internalType: 'string', name: 'content', type: 'string' },
          { internalType: 'string', name: 'metadata', type: 'string' },
        ],
        internalType: 'struct EthosDiscussion.Reply[]',
        name: 'result',
        type: 'tuple[]',
      },
    ],
  ...
  {
    inputs: [
      { internalType: 'uint256', name: 'replyId', type: 'uint256' },
      { internalType: 'string', name: 'content', type: 'string' },
      { internalType: 'string', name: 'metadata', type: 'string' },
    ],
    name: 'editReply',
  ...
  {
    inputs: [{ internalType: 'uint256[]', name: 'replyIds', type: 'uint256[]' }],
    name: 'repliesById',
    outputs: [
      {
        components: [
