/**
 * On the front-end we use viem and wagmi. But our BlockchainManager uses ethers.js. This
 * utility helps to convert a viem client to an ethers.js provider or signer.
 *
...
/**
 * Build viem Client from a RainbowKit config, and convert it to an ethers.js
 * Provider (for reading from blockchain)
 */
